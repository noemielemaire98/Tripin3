...
class FlightsAdapter(val flights: List<Flight>) :
    ...
    override fun onBindViewHolder(holder: FlightsViewHolder, position: Int) {
        ...
        flights.map {
            ...
            holder.flightsView.flights_title_textview.text = "${Flight.grandTotal} €"
            holder.flightsView.flights_date_textview.text =
                Flight.dateDepart
            holder.flightsView.flights_direct_textview.text = Flight.oneway.toDirect()
